  ...
  return {
    init : function(successCallback, errorCallback) {
      if(window.indexedDB) {
        ...
        errorCallback('storage_api_not_supported', 'The indexedDB storage api is not supported');
      }

    },
    initObjectStore : function(type, successCallback, errorCallback) {
      if(!database) {
        errorCallback('storage_api_not_initialized', 'The storage engine has not been initalized');
      }
      var exists = false;
